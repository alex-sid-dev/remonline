...
from src.application.commands.work.delete_work import DeleteWorkCommand, DeleteWorkCommandHandler
from src.application.commands.work.read_all_work import (
    ReadAllWorkCommand,
    ReadAllWorkCommandHandler,
    ReadWorkResponse,
)
from src.application.commands.work.read_work import ReadWorkCommand, ReadWorkCommandHandler
from src.application.commands.work.update_work import UpdateWorkCommand, UpdateWorkCommandHandler
...
async def update_work(
    ...
    dto = UpdateWorkCommand(uuid=work_uuid, **update_data)
