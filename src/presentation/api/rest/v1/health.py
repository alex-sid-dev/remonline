...
async def health_check(
    ...
    try:
        ...
        if any(keyword in error_str for keyword in ["connection", "timeout", "unreachable", "refused", "connect"]) or \
                any(keyword in error_type for keyword in ["connection", "timeout"]):
